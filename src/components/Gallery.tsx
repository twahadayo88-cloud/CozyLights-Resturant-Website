...
export default function Gallery() {
  ...
  return (
    <section id="gallery" className="py-24 bg-[#0A0A0A] relative border-t border-[#F9F5EE]/10">
      {/* Background glow shadow */}
      <div className="absolute top-1/4 right-[10%] w-[450px] h-[450px] bg-yellow-500/3 rounded-full blur-[100px] pointer-events-none" />

      <div className="max-w-7xl mx-auto px-6">
        {/* Section Header */}
        <div className="text-center mb-16">
          <span className="text-yellow-500 font-serif tracking-[4px] text-[10px] uppercase block mb-3 italic">Esthetic Chronicles</span>
          <h2 className="text-4xl md:text-5xl font-serif text-white uppercase leading-[1.1]">
            Visual Ambiance <span className="text-yellow-500 font-serif italic normal-case tracking-normal">Gallery</span>
          </h2>
            ...
            <button
              ...
              className={`px-4 py-2 rounded-none text-[10px] font-mono uppercase tracking-wider transition-all duration-300 cursor-pointer ${
                activeCategory === cat
                  ...
                  : "bg-[#0e0e0e] border border-[#F9F5EE]/10 text-neutral-400 hover:text-white"
              }`}
            >
              {cat}
            </button>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
          {filteredGallery.map((item, idx) => (
            <div
              ...
              className="group relative aspect-square rounded-none overflow-hidden border border-[#F9F5EE]/10 shadow-lg cursor-zoom-in hover:border-yellow-500/30 transition-colors duration-300"
            >
              {/* Blur backdrop overlay */}
              <div className="absolute inset-0 bg-[#0A0A0A]/40 group-hover:bg-[#0A0A0A]/10 transition-colors duration-400 z-10" />
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black via-black/40 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-400 z-20 flex flex-col justify-end p-6">
                <span className="text-[8px] font-mono text-yellow-500 uppercase tracking-widest block bg-yellow-500/10 px-2 py-0.5 w-max border border-yellow-500/10">
                  {item.category}
                </span>
                ...
                <div className="flex items-center gap-1.5 text-[10px] font-mono text-yellow-500 mt-4">
        ...
        {lightboxIdx !== null && (
          ...
          >
            ...
            <button
              onClick={() => setLightboxIdx(null)}
              className="absolute top-6 right-6 p-3 text-neutral-400 hover:text-white cursor-pointer hover:bg-neutral-900 rounded-none transition-colors"
            ...
            >
              <div className="relative w-full flex items-center justify-center">
                ...
                <button
                  onClick={handlePrev}
                  className="absolute left-2 md:left-4 p-3 bg-neutral-900/60 hover:bg-neutral-800 border border-[#F9F5EE]/15 text-white rounded-none transition-colors cursor-pointer"
                ...
                {/* Center Image */}
                <div className="max-h-[60vh] md:max-h-[70vh] rounded-none overflow-hidden border border-[#F9F5EE]/15 bg-[#0A0A0A] shadow-2xl">
                  <img
                ...
                <button
                  onClick={handleNext}
                  className="absolute right-2 md:right-4 p-3 bg-neutral-900/60 hover:bg-neutral-800 border border-[#F9F5EE]/15 text-white rounded-none transition-colors cursor-pointer"
              ...
              <div className="text-center max-w-xl space-y-2">
                <span className="text-[8px] font-mono text-yellow-500 uppercase tracking-widest block bg-yellow-500/10 px-2.5 py-1 rounded-none border border-yellow-500/25 w-max mx-auto">
