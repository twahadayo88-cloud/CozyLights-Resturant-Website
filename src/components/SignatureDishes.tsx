...
export default function SignatureDishes() {
  const spotlights = [
    ...
    },
    {
      ...
      price: 25,
      philosophy: "A rising hot pastry featuring highest-grade Uji matcha whisked with organic duck eggs. Surrounded by hand-painted white chocolate sakura branches and raspberry nectar droplets.",
  ...
  return (
    <section id="chef-specials" className="py-24 bg-[#081120]/40 relative overflow-hidden border-b border-[#F9F5EE]/10">
      {/* Decorative background orbs */}
      <div className="absolute top-[10%] left-[5%] w-[400px] h-[400px] bg-[#0F8A5F]/3 rounded-full blur-[110px] pointer-events-none" />
      <div className="absolute bottom-[10%] right-[10%] w-[400px] h-[400px] bg-[#6D0F24]/3 rounded-full blur-[110px] pointer-events-none" />

      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-20">
          <span className="text-yellow-500 font-serif tracking-[4px] text-[10px] uppercase block mb-3 italic">Signature Spotlights</span>
          <h2 className="text-4xl md:text-5xl font-serif text-white uppercase leading-[1.1]">
            Crafted for the <span className="font-serif italic text-yellow-500 normal-case tracking-normal">Imperial Palette</span>
          </h2>
          ...
          {spotlights.map((item, idx) => {
            ...
            return (
              ...
              >
                ...
                >
                  <div className="absolute inset-0 bg-[#0A0A0A]/40 group-hover:bg-transparent transition-colors duration-500 z-10" />
                  <img
                    src={item.img}
                    alt={item.name}
                  ...
                  />
                  <div className="absolute bottom-6 left-6 z-20 bg-[#0A0A0A]/85 backdrop-blur-md px-5 py-2.5 rounded-none border border-yellow-500/20">
                    <span className="text-[9px] font-mono text-yellow-500 tracking-[3px] uppercase">
                      0{idx + 1} / MASTERPIECE
                    </span>
                  </div>
                </div>
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-[9px] font-mono uppercase border border-yellow-500/20 text-yellow-500 px-3 py-1 rounded-none tracking-widest bg-yellow-500/5">
                      Executive Spotlight
                    </span>
                  </div>
                  ...
                  <div className="border-t border-[#F9F5EE]/10 pt-6 space-y-3">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                      {item.metrics.map((met, mIdx) => (
                        <div
                          key={mIdx}
                          className="p-3 bg-neutral-900/10 border border-[#F9F5EE]/10 rounded-none hover:border-yellow-500/25 transition-colors"
                        >
