...
export default function Contact() {
  ...
  const branchDetails = {
    ...
    Delhi: {
      name: "Sakura Royale – Delhi Palace",
      coordinates: "28.6139° N, 77.2090° E",
      address: "Chanakyapuri Sovereign Boulevard, Private Canopy Garden, New Delhi, India",
      phone: "+91 11-4455-7788",
      mail: "delhi@sakuraroyale.com",
      hours: {
  ...
  const activeInfo = activeBranch === "Tokyo" ? branchDetails.Tokyo : branchDetails.Delhi;
  ...
  return (
    <section id="contact" className="py-24 bg-[#0A0A0A] relative border-t border-[#F9F5EE]/10 overflow-hidden">
      {/* Decorative background grids */}
      <div className="absolute inset-0 bg-[linear-gradient(rgba(255,215,0,0.01)_1.5px,transparent_1.5px),linear-gradient(90deg,rgba(255,215,0,0.01)_1.5px,transparent_1.5px)] bg-[size:40px_40px] pointer-events-none" />

      <div className="max-w-7xl mx-auto px-6 z-10 relative">
        <div className="text-center mb-16">
          <span className="text-yellow-500 font-serif tracking-[4px] text-[10px] uppercase block mb-3 italic">Geographic Quadrants</span>
          <h2 className="text-4xl md:text-5xl font-serif text-white uppercase leading-[1.1]">
            Contact & <span className="text-yellow-500 font-serif italic normal-case tracking-normal">Reservations HQ</span>
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 max-w-6xl mx-auto items-stretch">
          ...
          <div className="lg:col-span-6 flex flex-col justify-between space-y-8 bg-[#0A0A0A] border border-[#F9F5EE]/10 p-8 rounded-none">
            {/* Branch Selector buttons */}
            <div className="flex gap-4 p-1.5 bg-[#0e0e0e] border border-[#F9F5EE]/10 rounded-none">
              <button
            ...
            <div className="space-y-6">
              <div>
                <span className="text-[9px] font-mono text-yellow-500 uppercase tracking-widest flex items-center gap-1.5 mb-2">
            ...
            <div className="border-t border-[#F9F5EE]/10 pt-6 space-y-4">
              ...
              <div className="space-y-2 text-xs leading-relaxed font-light">
                ...
                <p className="text-[10px] font-mono text-yellow-500/80 italic mt-2">
          ...
          <div className="lg:col-span-6 bg-[#0A0A0A] border border-[#F9F5EE]/10 rounded-none p-8 flex flex-col justify-between items-center text-center relative overflow-hidden min-h-[350px]">
            ...
            <div className="absolute inset-0 z-0 flex items-center justify-center opacity-[0.03] scale-125 select-none pointer-events-none">
              <Compass className="w-96 h-96 text-yellow-500 animate-spin-slow" />
            </div>

            <div className="w-full h-48 bg-neutral-950/40 rounded-none border border-[#F9F5EE]/10 flex flex-col justify-center items-center p-4 relative z-10 overflow-hidden select-none">
              {/* Dynamic Vector Map paths render */}
              <svg className="w-full h-24 stroke-yellow-500/25 fill-none stroke-2 stroke-dasharray-[6]" viewBox="0 0 300 100">
                <path d={activeInfo.vectorBlueprint} />
                <circle cx="150" cy="50" r="4" className="fill-yellow-500 stroke-yellow-500/40 stroke-4 animate-pulse" />
              </svg>
              <span className="text-[10px] font-mono text-neutral-500 mt-4 uppercase">
            ...
            <div className="space-y-4 z-10 mt-6 w-full">
              ...
              {/* Secret email signup */}
              {joinedGuild ? (
                <div className="p-3 bg-emerald-500/10 border border-emerald-500/30 text-emerald-400 font-mono text-[11px] tracking-wide max-w-sm mx-auto animate-fade-in-up">
                  ✦ CONFIRMED: PASSPORT ENTERED SECURELY IN SAKURA GUILD
                </div>
              ) : (
                <form onSubmit={handleGuildRegister} className="flex gap-2 w-full max-w-sm mx-auto pt-2">
                  <input
                    ...
                    className="w-full bg-neutral-900 border border-[#F9F5EE]/10 focus:border-yellow-500/30 rounded-none py-2.5 px-4 text-xs text-white placeholder-neutral-500 focus:outline-none"
                    required
                  />
                  <button
                    type="submit"
                    className="bg-yellow-500 hover:bg-yellow-400 text-black px-5 rounded-none text-xs font-mono uppercase tracking-wider font-semibold cursor-pointer active:scale-95"
                  >
                    Join
                  </button>
                </form>
