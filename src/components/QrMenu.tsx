...
export default function QrMenu() {
  ...
  return (
    <section id="qr-menu" className="py-24 bg-[#0A0A0A] relative border-b border-[#F9F5EE]/10 overflow-hidden">
      {/* Decorative luxury radial background spotlights */}
      <div className="absolute top-[20%] left-[-10%] w-[500px] h-[500px] bg-yellow-500/5 rounded-full blur-[130px] pointer-events-none" />
      <div className="absolute bottom-[20%] right-[-10%] w-[500px] h-[500px] bg-[#6D0F24]/3 rounded-full blur-[130px] pointer-events-none" />

      <div className="max-w-7xl mx-auto px-6 relative z-10">
        
        {/* Section Header */}
        <div className="text-center mb-16">
          <span className="text-yellow-500 font-serif tracking-[4px] text-[10px] uppercase block mb-3 italic">Digital Passport</span>
          <h2 className="text-4xl md:text-5xl font-serif text-white uppercase leading-[1.1]">
            Contactless <span className="text-yellow-500 font-serif italic normal-case tracking-normal">QR Gastro-Menu</span>
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center max-w-6xl mx-auto">
          ...
          <div className="lg:col-span-5 flex flex-col items-center text-center space-y-6">
            ...
            {/* Elegant Golden QR Frame container */}
            <div className="p-8 bg-[#0E0E0E] border-2 border-yellow-500/30 relative shadow-2xl group select-none flex flex-col items-center">
              ...
              <div className="flex items-center gap-1.5 mb-4 font-mono text-[9px] uppercase text-yellow-500/85">
                <span className="w-1.5 h-1.5 bg-yellow-500 animate-ping rounded-none" />
                <span>Encrypted Menu Link</span>
              </div>

              {/* Interactive Vector QR Code with overlay scanning laser laser */}
              <div className="relative w-64 h-64 bg-neutral-950 border border-neutral-900 p-6 flex justify-center items-center overflow-hidden">
                {/* Simulated Moving Scanning Laser Line */}
                <div className="absolute left-0 right-0 h-[2px] bg-gradient-to-r from-transparent via-yellow-500 to-transparent top-0 animate-[scan_3s_ease-in-out_infinite] z-20 shadow-[0_0_8px_rgba(234,179,8,0.7)] pointer-events-none" />
                ...
                <svg className="w-full h-full fill-white" viewBox="0 0 100 100">
                  ...
                  <rect x="42" y="42" width="16" height="16" className="fill-[#0E0E0E]" />
                </svg>

                {/* Fine Japanese Imperial Crest Symbol placed precisely in the center */}
                <div className="absolute w-8 h-8 bg-black border border-yellow-500/40 flex items-center justify-center select-none z-10 rotate-45">
                  <span className="text-[8px] text-yellow-500 font-serif font-bold uppercase tracking-widest -rotate-45">桜</span>
                </div>
              </div>

              {/* Character signature under banner */}
              <div className="mt-4">
                <span className="text-[10px] font-mono text-neutral-400">SAKURA DIGITAL GATEWAY v2.8</span>
              </div>
            </div>
            ...
            <div className="flex gap-4 w-full">
              ...
              <button
                ...
                className={`flex-1 py-3 border text-[10px] font-mono uppercase tracking-widest transition-all duration-300 cursor-pointer ${
                  simulatedScan
                    ...
                    : "bg-neutral-950/40 border-[#F9F5EE]/10 text-neutral-300 hover:border-yellow-500/40 hover:text-white"
                }`}
              >
              ...
              <button
                ...
                className="px-5 border border-[#F9F5EE]/10 bg-neutral-950/40 hover:border-yellow-500/40 text-neutral-300 hover:text-white flex items-center justify-center cursor-pointer transition-all disabled:opacity-40"
                aria-label="Download Menu Vector"
              >
                {isDownloading ? (
                  <span className="w-4 h-4 border-2 border-yellow-500/30 border-t-yellow-500 animate-spin" />
                ) : downloadComplete ? (
            ...
            {downloadComplete && (
              <p className="text-[9px] font-mono text-emerald-400 animate-fade-in-up uppercase tracking-widest">
          ...
          <div className="lg:col-span-7 space-y-8 z-10 relative">
            ...
            <div className="bg-[#0A0A0A] border border-[#F9F5EE]/10 rounded-none p-6 md:p-8 shadow-2xl relative min-h-[340px] flex flex-col justify-between">
              ...
              {!simulatedScan ? (
                ...
                <div className="space-y-6 my-auto">
                  ...
                  <p className="text-neutral-400 text-xs leading-relaxed opacity-85">
                    Our digital menu changes dynamically depending on the barometric pressure in Tokyo, active wind patterns above Delhi, and server-side Michelin criteria. By scanning, you instantiate an encrypted culinary license that reveals:
                  </p>

                  <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-[11px] text-neutral-400 font-mono">
                    <li className="flex items-center gap-2 text-neutral-300">
                      <span className="text-yellow-500">✦</span> Sommelier's Secret Cellar Flight
                    </li>
                    <li className="flex items-center gap-2 text-neutral-300">
                      <span className="text-yellow-500">✦</span> Real-time Dashi Heat Indexes
                    </li>
                    <li className="flex items-center gap-2 text-neutral-300">
                      <span className="text-yellow-500">✦</span> Rare Seasonal Saffron Sourcing
                    </li>
                    <li className="flex items-center gap-2 text-neutral-300">
                      <span className="text-yellow-500">✦</span> Instant All-Weather Reservations
                    </li>
                  </ul>
                </div>
              ) : (
                ...
                <div className="space-y-6 animate-fade-in-up">
                  ...
                  <div className="flex justify-between items-center pb-4 border-b border-[#F9F5EE]/10">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[10px] font-mono text-white uppercase tracking-widest">
                        SAKURA_SECURE://digital-carte-unlocked
                      </span>
                    </div>
                    <span className="text-[9px] font-mono bg-yellow-500/10 border border-yellow-500/25 text-yellow-500 px-2 py-0.5 uppercase">
                      Pass Verified
                    </span>
                  </div>
                  ...
                  <div className="space-y-2">
                    <h3 className="text-base font-serif text-white uppercase tracking-wide">
                      Scan Revealed: <span className="text-yellow-500 italic">Off-Menu Masterpieces</span>
                    </h3>
                      ...
                      <div 
                        ...
                        className={`p-4 border transition-all duration-300 cursor-pointer ${
                          unlockedSecret === dish.id 
                            ...
                            : "bg-neutral-950/60 border-[#F9F5EE]/10 hover:border-neutral-800"
                        }`}
                      >
                        <div className="flex justify-between items-baseline">
                          <span className="text-[8px] font-mono text-yellow-500 uppercase tracking-widest">{dish.category}</span>
                          <span className="text-xs font-serif text-yellow-500 font-semibold">${dish.price}</span>
                        </div>
                        ...
                        {unlockedSecret === dish.id && (
                          <p className="text-[11px] text-neutral-400 mt-2 leading-relaxed font-light border-t border-neutral-900 pt-2 animate-fade-in-up">
                            {dish.description}
                          </p>
                        )}
                      </div>
              ...
              <div className="mt-6 pt-6 border-t border-[#F9F5EE]/10">
                <span className="text-[9px] font-mono text-yellow-500 uppercase tracking-widest block mb-4">
                  Dispatch Passport Menu Link Instantly to Phone:
                </span>

                {successSent ? (
                  <div className="p-3 bg-emerald-500/10 border border-emerald-500/35 text-emerald-400 font-mono text-[10px] uppercase tracking-widest text-center animate-fade-in-up">
                  ...
                  <form onSubmit={handleSendMenu} className="flex gap-2">
                    <input
                      ...
                      className="flex-1 bg-[#0E0E0E] border border-[#F9F5EE]/10 focus:border-yellow-500/30 rounded-none py-2.5 px-4 text-xs text-white placeholder-neutral-600 focus:outline-none"
                      required
                    />
                    <button
                      type="submit"
                      className="bg-yellow-500 hover:bg-yellow-400 text-black px-6 rounded-none text-xs font-mono uppercase tracking-widest font-semibold cursor-pointer transition-colors active:scale-95 flex items-center gap-1.5"
                    >
            ...
            <p className="text-[10px] font-mono text-neutral-500 leading-relaxed text-right">
              Prefer direct browser view? <a href="#" onClick={(e) => { e.preventDefault(); setSimulatedScan(true); }} className="text-yellow-500 hover:underline inline-flex items-center gap-1">Open Virtual carte <ExternalLink className="w-3 h-3" /></a>
            </p>
