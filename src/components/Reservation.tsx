...
export default function Reservation() { 
  ...
  const [seatingPreference, setSeatingPreference] = useState("Cozy Blossom Garden View Canopy"); 
  ...
  const seatingZones = [ 
    { name: "Cozy Blossom Garden View Canopy", desc: "Dine under authentic glowing pink blossoms inside custom wooden partitions", multiplier: "+$10/person" }, 
  ...
  return ( 
    <section id="reservations" className="py-24 bg-[#1A1A1D]/40 relative border-b border-[#F9F5EE]/10"> 
      {/* Background soft red bokeh lights */} 
      <div className="absolute bottom-10 right-0 w-[450px] h-[450px] bg-[#6F2232]/5 rounded-full blur-[110px] pointer-events-none" /> 
 
      <div className="max-w-7xl mx-auto px-6"> 
        {/* Section Header */} 
        <div className="text-center mb-16"> 
          <span className="text-[#C3073F] font-serif tracking-[4px] text-[10px] uppercase block mb-3 italic">Sovereign Seating</span> 
          <h2 className="text-4xl md:text-5xl font-serif text-white uppercase leading-[1.1]"> 
            Secure Your <span className="text-[#C3073F] font-serif italic normal-case tracking-normal">Imperial Table</span> 
          </h2> 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 max-w-6xl mx-auto items-start"> 
          ...
          <div className="lg:col-span-5 space-y-6"> 
            <div className="bg-[#1A1A1D] border border-[#F9F5EE]/10 rounded-none p-6 space-y-6"> 
              <div className="flex justify-between items-center"> 
                <h3 className="text-[10px] font-semibold text-white uppercase tracking-[0.2em] font-mono"> 
                  Select Seating Zone 
                </h3> 
                <span className="text-[9px] bg-[#C3073F]/10 text-[#C3073F] px-2.5 py-0.5 rounded-none font-mono uppercase tracking-widest border border-[#C3073F]/25"> 
                  Live Selection 
                </span> 
              </div> 
                  ...
                  <button 
                    ...
                    className={`w-full text-left p-4 rounded-none border transition-all duration-300 relative group cursor-pointer ${ 
                      seatingPreference === zone.name 
                        ? "bg-[#1A1A1D] border-[#C3073F]/50 shadow-lg" 
                        : "bg-[#1A1A1D]/40 border-[#F9F5EE]/10 hover:border-[#4E4E50]" 
                    }`} 
                  > 
                    <div className="flex justify-between items-center"> 
                      <span className={`text-[11px] font-serif uppercase tracking-wider ${ 
                        seatingPreference === zone.name ? "text-[#C3073F]" : "text-white group-hover:text-[#C3073F]/80" 
                      }`}> 
                        {zone.name} 
                      </span> 
              ...
              <div className="p-4 bg-transparent rounded-none border border-[#C3073F]/25 flex items-start gap-3"> 
                <Info className="w-4 h-4 text-[#C3073F] shrink-0 mt-0.5" /> 
            ...
            <div className="bg-[#1A1A1D] border border-[#F9F5EE]/10 rounded-none p-4 flex justify-between items-center"> 
              <span className="text-[10px] text-neutral-400 font-light">Have an active booking registered?</span> 
              <button 
                onClick={() => setViewHistory(!viewHistory)} 
                className="text-[10px] font-mono text-[#C3073F] hover:text-[#950740] uppercase tracking-widest cursor-pointer flex items-center gap-1.5" 
              > 
            ...
            {viewHistory && ( 
              <div className="space-y-4 max-h-[300px] overflow-y-auto pr-2 animate-fade-in-up"> 
                {activeBookings.map((b) => ( 
                  <div key={b.id} className="p-4 rounded-none bg-[#1A1A1D] border border-[#F9F5EE]/10 space-y-2"> 
                    <div className="flex justify-between items-center text-[10px] font-mono text-neutral-500 uppercase"> 
                      <span>ID: {b.id}</span> 
                      <span className="text-[#C3073F] font-semibold">✦ SECURED VOUCHER</span> 
                    </div> 
                    ...
                    {b.specialRequests && ( 
                      <p className="text-[10px] text-[#C3073F]/80 italic font-mono">“{b.specialRequests}”</p> 
                    )} 
                  </div> 
                ))} 
              </div> 
          ...
          <div className="lg:col-span-7 bg-[#1A1A1D] border border-[#F9F5EE]/10 rounded-none p-6 md:p-8"> 
            {!successBooking ? ( 
              <form onSubmit={handleBooking} className="space-y-6"> 
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6"> 
                  ...
                  <div className="space-y-2"> 
                    ...
                    <input 
                      ...
                      className="w-full bg-[#1A1A1D] border border-[#F9F5EE]/10 focus:border-[#C3073F]/30 rounded-none py-2.5 px-4 text-xs text-white focus:outline-none" 
                      required 
                    /> 
                  </div> 
                  ...
                  <div className="space-y-2"> 
                    ...
                    <div className="relative"> 
                      <select 
                        ...
                        className="w-full bg-[#1A1A1D] border border-[#F9F5EE]/10 focus:border-[#C3073F]/30 rounded-none py-2.5 pl-4 pr-10 text-xs text-white focus:outline-none appearance-none cursor-pointer" 
                      > 
                        {[1, 2, 3, 4, 5, 6, 7, 8, 10].map((num) => ( 
                          <option key={num} value={num} className="bg-[#1A1A1D]"> 
                  ...
                  <div className="space-y-2"> 
                    ...
                    <div className="relative"> 
                      <input 
                        ...
                        className="w-full bg-[#1A1A1D] border border-[#F9F5EE]/10 focus:border-[#C3073F]/30 rounded-none py-2.5 pl-4 pr-10 text-xs text-white focus:outline-none" 
                        required 
                      /> 
                    ...
                    <div className="relative"> 
                      ...
                      > 
                        {["12:00", "13:30", "15:00", "18:00", "19:00", "20:00", "21:30", "22:00"].map((slot) => ( 
                          <option key={slot} value={slot} className="bg-[#1A1A1D]"> 
                            {slot} 
                          </option> 
                        ))} 
                      </select> 
                ...
                <div className="space-y-2"> 
                  ...
                  <textarea 
                    ...
                    className="w-full bg-[#1A1A1D] border border-[#F9F5EE]/10 focus:border-[#C3073F]/30 rounded-none py-2.5 px-4 text-xs text-white focus:outline-none h-20 resize-none" 
                  /> 
                </div> 
 
                {/* Terms and conditions signature details */} 
                <p className="text-[10px] text-neutral-500 font-mono tracking-wider leading-relaxed"> 
                  ✦ By clicking below, you authenticate this placement in real-time as an official booking contract status at Cozy Lights. 
                </p> 
                ...
                <button 
                  ...
                  className="w-full py-4 bg-[#C3073F] hover:bg-[#950740] disabled:opacity-55 text-black text-xs font-mono uppercase tracking-[0.25em] font-bold rounded-none transition-all duration-300 flex items-center justify-center gap-2 cursor-pointer shadow-lg active:scale-99 font-medium" 
                > 
              ...
              <div className="text-center py-12 px-6 flex flex-col items-center justify-center space-y-6 animate-fade-in-up"> 
                <div className="w-16 h-16 rounded-none bg-[#C3073F]/10 border border-[#C3073F]/35 flex justify-center items-center text-[#C3073F]"> 
                  <ShieldCheck className="w-8 h-8 animate-bounce" /> 
                </div> 
 
                <div className="space-y-2"> 
                  <span className="text-[9px] font-mono uppercase bg-[#C3073F]/10 text-[#C3073F] px-3 py-1 rounded-none border border-[#C3073F]/30 tracking-widest inline-block"> 
                ...
                <div className="w-full max-w-sm rounded-none bg-[#1A1A1D] p-6 border-2 border-[#C3073F] relative overflow-hidden text-left space-y-4 shadow-xl"> 
                  {/* Ticket notched circles decorative details */} 
                  <div className="absolute top-1/2 -left-3 -translate-y-1/2 w-6 h-6 bg-[#1A1A1D] border-r border-[#F9F5EE]/10" /> 
                  <div className="absolute top-1/2 -right-3 -translate-y-1/2 w-6 h-6 bg-[#1A1A1D] border-l border-[#F9F5EE]/10" /> 
                  ...
                  <div className="flex justify-between items-center text-[9px] font-mono text-neutral-500 uppercase pb-2 border-b border-[#F9F5EE]/10 tracking-widest"> 
                    ...
                    <span className="text-[#C3073F]">Cozy Lights</span> 
                  </div> 
                  ...
                  <div> 
                    ...
                    <span className="text-xs font-serif uppercase tracking-wider text-[#C3073F] block mt-0.5">{successBooking.seatingPreference}</span> 
                  </div> 
                </div> 
 
                <button 
                  onClick={() => setSuccessBooking(null)} 
                  className="px-6 py-2.5 border border-[#F9F5EE]/15 hover:border-[#C3073F] rounded-none text-[10px] font-mono text-neutral-400 hover:text-white uppercase tracking-widest transition-colors cursor-pointer" 
                > 
