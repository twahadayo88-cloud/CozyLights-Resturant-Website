...
export const IMAGES = {
  ...
  sakuraCocktail: "/src/assets/images/dish_cocktail_1780226933463.png",
};
...
export const MENU_ITEMS: MenuItem[] = [
  ...
  },
  {
    ...
    tags: ["Vegetarian", "Royal Indian", "Wasabi Glasswear"],
    isVegetarian: true,
    spicyLevel: 1
  },
  {
  ...
  // --- MAIN COURSE ---
  {
    ...
    description: "Creamy imperial saffron-dashi broth, hand-cut wheat noodles, butter-tender sliced Miyazaki A5 Wagyu beef, crowned with 24-karat gold foil, soft organic shoyu egg, and fresh sakura blossoms.",
    price: 68,
  ...
  {
    id: "mains-3",
    name: "Sakura Crusted Venison Fillet",
    nativeName: "鹿肉の桜ロースト",
    description: "Premium New Zealand venison loin, crusted with freeze-dried sakura blossoms and pink peppercorns, served with sweet kabocha pumpkin purée, roasted wild matsutake mushrooms, and red plum reduction.",
    price: 58,
    category: "Main Course",
    imageUrl: "https://images.unsplash.com/photo-1544025162-d76694265947?auto=format&fit=crop&q=80&w=800",
    tags: ["Exotic", "Sakura Taste"],
    isVegetarian: false,
    spicyLevel: 0
  },
  {
  ...
  {
    id: "desserts-2",
    name: "Sakura Lychee Rose Mousse",
  ...
  // --- BEVERAGES ---
  {
    ...
    description: "Shimmering rose-tinted fine crystal glass blend of pure sakura botanical distillate, elderflower liqueur, champagne bubbles, and edible liquid gold flakes.",
    price: 28,
    category: "Beverages",
    imageUrl: IMAGES.sakuraCocktail,
...
export const GALLERY_ITEMS: GalleryItem[] = [
  ...
  {
    id: "gal-6",
    title: "Imperial Sakura Banquet Night",
    category: "Events",
...
export const REVIEWS_LIST: Review[] = [
  {
    ...
    text: "An ethereal marriage of historical Japanese patience and Indian royal aroma. The Royal Saffron Ramen was an emotional experience. The gold leaf shimmered in Tokyo's night lights perfectly.",
    rating: 5,
  ...
  },
  {
    ...
    text: "As someone who writes stories, Sakura Royale looks like it was plucked straight from a Royal Palace anime scene. Every dynamic hover detail, the subtle sound of Gyokuro steam, and Chef's warm recommendations makes me feel like a king.",
    rating: 5,
